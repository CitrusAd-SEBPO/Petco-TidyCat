/**----------------------
    ...
    advanceArrows("citrus_tidyCat_scroller1_tab1");
    ...
    document.addEventListener("DOMContentLoaded", function () {
        filterProducts("citrus_tidyCat_scroller1_tab1");
    });
    // for dog filter function
    function filterProducts(c) {
        var x, i;
        x = document.getElementsByClassName("citrus_tidyCat__Product");
        if (c == "all") c = "";
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var dogBtnContainer = document.getElementById("citrus_tidyCatTabId");
        var dogBtns = dogBtnContainer.getElementsByClassName("citrus_tidyCat__tab_item");
